...
def deepest_child(c):
    print("Hello from deepest child")


def deeper_child(b):
    print("Hello from deeper child")
    deepest_child("c")


def child_function(a):
...
def my_example_function(arg1):
    return "RETURNED " + arg1
...
def delegate(function, targets):
    ...
    daemon_path = os.path.join(current_dir, "sub.py")
    ...
    try:
        ...
        result = subprocess.call(args_array)
        return result
...
if __name__ == "__main__":
    ...
    delegate(my_example_function, targets)
